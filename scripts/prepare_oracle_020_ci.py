#!/usr/bin/env python3
"""Prepare the exact published pristine Oracle 0.20.0 package for CI tests."""
...
ORACLE_VERSION = "0.20.0"
ORACLE_INTEGRITY = "sha512-BcrY4W6Wp1qwAZ1H1wD9vMLHhrzMKXYn82ArTC2ISBFSRZsK5WN+udXTXIeDpTkONfOu0SUsrVYthApoEJ9gWg=="
MAX_FILES = 10_000
...
def main() -> int:
    ...
    stage = Path(tempfile.mkdtemp(prefix="oracle-020-ci-", dir=runner_temp))
    ...
    with github_env.open("a", encoding="utf-8", newline="\n") as output:
        output.write(f"ORACLE_020_PACKAGE_ROOT={package_root}\n")
        output.write(f"ORACLE_020_PACKAGE_ARCHIVE={archive}\n")
